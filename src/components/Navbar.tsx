      ...
      <nav className="bg-[#F6F7FB] z-10">
        <div className=" mx-auto flex items-center justify-between p-2  lg:px-8">
          ...
          <div className="hidden md:flex lg:space-x-6 md:space-x-4 items-center">
            ...
            <a
              href="#"
              className="hover:text-[#E6A371] uppercase text-xs font-bold"
            >
              Features
            </a>
            <a
              href="#"
              className="hover:text-[#E6A371] uppercase flex-shrink-0 whitespace-nowrap text-xs font-bold"
            >
              About Us
            </a>
            <a
            ...
            <button className="text-sm border hover:bg-[#E6A371] hover:text-white hover:border-[#E6A371] border-black rounded py-2 px-4 font-bold flex-shrink-0 whitespace-nowrap">
              LOG IN
            </button>
            <button className="bg-[#E6A371] text-white py-2 px-4 rounded-sm text-sm uppercase flex-shrink-0 whitespace-nowrap font-bold hover:bg-[#4f2a0f]">
              Get Started
            </button>
          </div>
        </div>
